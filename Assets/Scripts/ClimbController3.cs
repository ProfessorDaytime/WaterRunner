...
public class ClimbController3 : MonoBehaviour
{
    ...
    void FixedUpdate(){
        ...
        Vector3 moveDirection = Quaternion.FromToRotation(cam.up, Vector3.up) * cam.TransformDirection(new Vector3(input.x, 0f, input.y));
    ...
    void HandleWalking(Vector3 moveDirection){
        ...
        anim.SetFloat("movementValue", moveDirection.magnitude);
        // anim.SetFloat("movementValue", Vector2)
